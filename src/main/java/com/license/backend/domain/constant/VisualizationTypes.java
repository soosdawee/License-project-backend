...
public enum VisualizationTypes {
    ...
    public static final String LINE_CHART_NAME = "LINE_CHART";
    public static final String SCATTER_PLOT_NAME = "SCATTER_PLOT";
    public static final String AREA_CHART_NAME = "AREA_CHART";
